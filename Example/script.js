...
if(typeof InstallTrigger !== 'undefined'){
    ...
    $(".tipP").text("Wheel to go")
    document.onkeydown = function (e) {
        return false;
    }

}else{
    $(".tipP").text("Wheel or keyboard to go")
...
for(var j=0; j<2; j++){
    ...
    $(".imgTable11").css({
        "width": Math.floor(winH*2)
    }),
        $(".imgTable11").css({
            "height": Math.floor(charH)
        });
    $(".imgTable11").css({
        "left": Math.floor(winH*0.2)
    });
    $(".imgTable12").css({
        "width": Math.floor(winH*2)
    }),
...
for(var j=0; j<2; j++) {
    ...
    $(".imgTable31").css({
        "width": Math.floor(charH * 2)
    })
    $(".imgTable31").css({
        "height": Math.floor(charH+winH*0.3)
    });
    $(".imgTable31").css({
        "left": Math.floor(winH * 1.47)
    });
    $(".imgTable31").css({
        "top": Math.floor(charH+winH*0.2)
    });
    $(".imgTable32").css({
        "width": Math.floor(charH * 2)
    })
...
$(".wall").css({
    "width": Math.floor(charH * 6.45)
})
$(".wall").css({
    "height": Math.floor(charH+winH*1)
});
$(".wall").css({
    "left": Math.floor(winH * 2.06)
});
$(".wall").css({
    "top": Math.floor(-charH*0.65)
});


$(".imgTable41").css({
    "left": Math.floor(winW*0.01)
});
$(".imgTable41").css({
...
$(".c1").css({
    "width": Math.floor(charH * 1.67)
})
$(".c1").css({
    "height": Math.floor(charH+winH*0.35)
});
$(".c1").css({
    "left": 0
});
$(".c1").css({
    "top": Math.floor(charH+winH*0.3)
});
...
$(".charFace2").css({
    "width": Math.ceil(charH*1.1)
})
$(".charFace2").css({
    "height": Math.ceil(charH*1.4)
});
$(".charFace2").css({
    "left": Math.ceil(charH*0.415)
});
$(".charFace2").css({
    "top":Math.ceil(charH*2.85)
});
...
function set(s){
    ...
    c(s*0.8,1.5,2,4,"easeInOutQuad",400);
}
